# AdressApiFrance SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AdressApiFranceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AdressApiFranceSDK(...) and AdressApiFranceSDK.test(...) become
#      AdressApiFranceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "adressapifrance_sdk"
_SDK_CLASS = "AdressApiFranceSDK"
...
_ENTITIES = {
    "BatchGeocoding": "batch_geocoding",
    "Geocoding": "geocoding",
}
