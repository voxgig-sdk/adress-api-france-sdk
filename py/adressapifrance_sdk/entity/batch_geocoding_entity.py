...
from adressapifrance_sdk.adressapifrance_types import (
    BatchGeocoding,
...
class BatchGeocodingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BatchGeocodingEntity(self._client, opts)
    ...
    def data_get(self) -> BatchGeocoding:
    ...
    def match_get(self) -> BatchGeocoding:
    ...
    def create(self, reqdata: BatchGeocodingCreateData, ctrl=None) -> BatchGeocoding:
        utility = self._utility
