...
from adressapifrance_sdk.utility import register

# Load features
from adressapifrance_sdk.feature.base_feature import AdressApiFranceBaseFeature
from adressapifrance_sdk.features import _has_feature, _make_feature
...
class AdressApiFranceSDK:
    ...
    def get_utility(self):
        return AdressApiFranceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AdressApiFranceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def BatchGeocoding(self, data=None) -> "BatchGeocodingEntity":
        ...
        from adressapifrance_sdk.entity.batch_geocoding_entity import BatchGeocodingEntity
    ...
    def Geocoding(self, data=None) -> "GeocodingEntity":
        ...
        from adressapifrance_sdk.entity.geocoding_entity import GeocodingEntity
