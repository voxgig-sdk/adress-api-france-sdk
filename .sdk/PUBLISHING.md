...
|---|---|---|
| `ts/` | @voxgig-sdk/adress-api-france-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/adress-api-france-sdk \
      --repository voxgig-sdk/adress-api-france-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/adress-api-france-sdk` shows it, and
`npm trust revoke @voxgig-sdk/adress-api-france-sdk --id=<id>` removes it.
