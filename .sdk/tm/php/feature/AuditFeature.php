...
// AdressApiFrance SDK audit feature
...
class AdressApiFranceAuditFeature extends AdressApiFranceBaseFeature
{
    ...
    private function _emit(AdressApiFranceContext $ctx, string $outcome): void
    {
