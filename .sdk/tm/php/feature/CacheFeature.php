...
// AdressApiFrance SDK cache feature
...
class AdressApiFranceCacheFeature extends AdressApiFranceBaseFeature
{
    ...
    private function _through(AdressApiFranceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
