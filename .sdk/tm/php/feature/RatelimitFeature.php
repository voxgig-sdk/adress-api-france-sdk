...
// AdressApiFrance SDK ratelimit feature
...
class AdressApiFranceRatelimitFeature extends AdressApiFranceBaseFeature
{
    ...
    private function _acquire(AdressApiFranceContext $ctx): void
    {
    ...
    private function _track(AdressApiFranceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
