...
// AdressApiFrance SDK timeout feature
...
class AdressApiFranceTimeoutFeature extends AdressApiFranceBaseFeature
{
    ...
    private function _with_timeout(AdressApiFranceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AdressApiFranceContext $_ctx, float $ms): void
    {
        $client = $this->client;
