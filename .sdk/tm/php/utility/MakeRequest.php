...
// AdressApiFrance SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AdressApiFranceMakeRequest
{
    public static function call(AdressApiFranceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AdressApiFranceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AdressApiFranceResponse($fetched);
        } else {
