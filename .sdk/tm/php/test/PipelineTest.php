...
// AdressApiFrance SDK pipeline test
//
...
{
    private static function utility(): AdressApiFranceUtility
    {
        return new AdressApiFranceUtility();
    }
    ...
    private static function ctx(array $over = []): AdressApiFranceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AdressApiFranceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AdressApiFranceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AdressApiFranceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AdressApiFranceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AdressApiFranceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AdressApiFranceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AdressApiFranceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AdressApiFranceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AdressApiFranceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AdressApiFranceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AdressApiFranceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AdressApiFranceResponse([]),
            'result' => new AdressApiFranceResult([]),
        ]);
        [, $err] = AdressApiFranceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AdressApiFranceSpec([]),
            'response' => null,
            'result' => new AdressApiFranceResult([]),
        ]);
        [, $err] = AdressApiFranceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AdressApiFranceSpec(['step' => 's']),
            'response' => new AdressApiFranceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AdressApiFranceResult([]),
        ]);
        [, $err] = AdressApiFranceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AdressApiFranceSpec(['step' => 's']),
            'response' => new AdressApiFranceResponse(self::resp(200, ['v' => 1])),
            'result' => new AdressApiFranceResult([]),
        ]);
        [, $err] = AdressApiFranceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AdressApiFranceSpec(['step' => 's']),
            'response' => new AdressApiFranceResponse(self::resp(200, ['v' => 2])),
            'result' => new AdressApiFranceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AdressApiFranceMakeResponse::call($ctx);
    ...
    {
        $preset = new AdressApiFranceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AdressApiFranceSpec([]),
            'response' => new AdressApiFranceResponse([]),
            'result' => new AdressApiFranceResult([]),
        ...
        [$got, $err] = AdressApiFranceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AdressApiFranceResult([])]);
        [, $err] = AdressApiFranceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AdressApiFranceSpec([]), 'result' => null]);
        [, $err] = AdressApiFranceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AdressApiFranceSpec(['step' => 's']),
            'result' => new AdressApiFranceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AdressApiFranceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AdressApiFranceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AdressApiFranceSpec(['step' => 's']),
            'result' => new AdressApiFranceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AdressApiFranceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AdressApiFranceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AdressApiFranceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AdressApiFranceSpec([]),
            'result' => new AdressApiFranceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AdressApiFranceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AdressApiFranceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AdressApiFranceError('boom', 'boom');
        $utility->fetcher = function (AdressApiFranceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AdressApiFranceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AdressApiFranceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AdressApiFranceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AdressApiFranceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AdressApiFranceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AdressApiFranceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AdressApiFranceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AdressApiFranceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AdressApiFranceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AdressApiFranceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AdressApiFranceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AdressApiFranceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AdressApiFranceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AdressApiFranceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AdressApiFranceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AdressApiFranceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AdressApiFranceResult(['ok' => false])]);
        $this->expectException(AdressApiFranceError::class);
        AdressApiFranceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AdressApiFranceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AdressApiFranceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AdressApiFranceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AdressApiFranceBaseFeature();
        $b = new AdressApiFranceBaseFeature();
        AdressApiFranceFeatureAdd::call($ctx, $a);
        AdressApiFranceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AdressApiFranceBaseFeature
    {
        $f = new AdressApiFranceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AdressApiFranceFeatureAdd::call($ctx, self::named_feature('a'));
        AdressApiFranceFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        AdressApiFranceFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        AdressApiFranceFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        AdressApiFranceFeatureAdd::call($ctx, $replace);
        ...
        AdressApiFranceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AdressApiFranceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AdressApiFranceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AdressApiFrancePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AdressApiFrancePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AdressApiFranceResponse(['headers' => null]),
            'result' => new AdressApiFranceResult([]),
        ]);
        AdressApiFranceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AdressApiFranceResultBody::call($ctx);
