...
// AdressApiFrance SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AdressApiFranceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AdressApiFranceOmni::structfix($now, Struct::undef()))
                        !== json_encode(AdressApiFranceOmni::structfix($val, Struct::undef()))) {
