...
from projectname_sdk.core.control import AdressApiFranceControl
...
class AdressApiFranceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AdressApiFranceControl()
        ...
        if isinstance(sp, AdressApiFranceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AdressApiFranceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AdressApiFranceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AdressApiFranceOperation({})
    ...
    def make_error(self, code, msg):
        return AdressApiFranceError(code, msg, self)
