...
func registerSDKWords(r *eng.Registry, client *sdk.AdressApiFranceSDK) {
...
func runOp(client *sdk.AdressApiFranceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
