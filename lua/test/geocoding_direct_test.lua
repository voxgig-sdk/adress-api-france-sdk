...
describe("GeocodingDirect", function()
  it("should direct-list-geocoding", function()
    local setup = geocoding_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-geocoding", setup.live and "live" or "unit")
...
function geocoding_direct_setup(mockres)
