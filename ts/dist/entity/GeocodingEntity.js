...
class GeocodingEntity extends AdressApiFranceEntityBase_1.AdressApiFranceEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'geocoding';
        this.name_ = 'geocoding';
        this.Name = 'Geocoding';
    }
    make() {
        return new GeocodingEntity(this._client, this.entopts());
    }
...
exports.GeocodingEntity = GeocodingEntity;
//# sourceMappingURL=GeocodingEntity.js.map