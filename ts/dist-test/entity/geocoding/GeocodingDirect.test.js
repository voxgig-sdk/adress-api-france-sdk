...
(0, node_test_1.describe)('GeocodingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AdressApiFranceSDK({
    ...
    (0, node_test_1.test)('direct-list-geocoding', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-geocoding', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AdressApiFranceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['ADRESS_API_FRANCE_TEST_GEOCODING_ENTID'];
    ...
    const client = new __1.AdressApiFranceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GeocodingDirect.test.js.map