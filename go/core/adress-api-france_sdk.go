...
type AdressApiFranceSDK struct {
	Mode     string
...
func (sdk *AdressApiFranceSDK) OptionsMap() map[string]any {
...
func (sdk *AdressApiFranceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AdressApiFranceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AdressApiFranceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AdressApiFranceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AdressApiFranceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AdressApiFranceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AdressApiFranceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AdressApiFranceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AdressApiFranceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AdressApiFranceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AdressApiFranceSDK {
	...
	sdk := NewAdressApiFranceSDK(sdkopts)
	sdk.Mode = "test"
