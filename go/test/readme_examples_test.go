...
const testSeed = `map[string]any{"entity": map[string]any{"batch_geocoding": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "geocoding": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
