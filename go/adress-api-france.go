...
// instead of `sdk.NewAdressApiFranceSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AdressApiFranceSDK  { return NewAdressApiFranceSDK(nil) }
func Test() *AdressApiFranceSDK { return TestSDK(nil, nil) }
