...
type BatchGeocodingEntity struct {
	name    string
	client  *core.AdressApiFranceSDK
...
func NewBatchGeocodingEntity(client *core.AdressApiFranceSDK, entopts map[string]any) *BatchGeocodingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BatchGeocodingEntity) GetName() string { return e.name }
...
func (e *BatchGeocodingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BatchGeocodingEntity) Deleted() bool {
	return e.deleted
}


func (e *BatchGeocodingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBatchGeocodingEntity(e.client, opts)
}

func (e *BatchGeocodingEntity) Data(args ...any) any {
...
func (e *BatchGeocodingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BatchGeocoding; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BatchGeocodingEntity) DataTyped(data ...BatchGeocoding) BatchGeocoding {
	if len(data) > 0 {
		return typedFrom[BatchGeocoding](e.Data(asMap(data[0])))
	}
	return typedFrom[BatchGeocoding](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BatchGeocoding (all fields
// optional at the wire level).
func (e *BatchGeocodingEntity) MatchTyped(match ...BatchGeocoding) BatchGeocoding {
	if len(match) > 0 {
		return typedFrom[BatchGeocoding](e.Match(asMap(match[0])))
	}
	return typedFrom[BatchGeocoding](e.Match())
}
...
func (e *BatchGeocodingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BatchGeocodingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BatchGeocodingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BatchGeocodingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BatchGeocodingCreateData and returns an BatchGeocoding. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BatchGeocodingEntity) CreateTyped(reqdata BatchGeocodingCreateData, ctrl map[string]any) (BatchGeocoding, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BatchGeocoding{}, err
	}
	return typedFrom[BatchGeocoding](res), nil
}



func (e *BatchGeocodingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BatchGeocodingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BatchGeocodingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
