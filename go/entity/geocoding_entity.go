...
func NewGeocodingEntity(client *core.AdressApiFranceSDK, entopts map[string]any) *GeocodingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GeocodingEntity) GetName() string { return e.name }
...
func (e *GeocodingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GeocodingEntity) Deleted() bool {
	return e.deleted
}


func (e *GeocodingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGeocodingEntity(e.client, opts)
}

func (e *GeocodingEntity) Data(args ...any) any {
...
func (e *GeocodingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Geocoding; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GeocodingEntity) DataTyped(data ...Geocoding) Geocoding {
	if len(data) > 0 {
		return typedFrom[Geocoding](e.Data(asMap(data[0])))
	}
	return typedFrom[Geocoding](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Geocoding (all fields
// optional at the wire level).
func (e *GeocodingEntity) MatchTyped(match ...Geocoding) Geocoding {
	if len(match) > 0 {
		return typedFrom[Geocoding](e.Match(asMap(match[0])))
	}
	return typedFrom[Geocoding](e.Match())
}
...
func (e *GeocodingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GeocodingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GeocodingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GeocodingListMatch and returns []Geocoding. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GeocodingEntity) ListTyped(reqmatch GeocodingListMatch, ctrl map[string]any) ([]Geocoding, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Geocoding](res), nil
}



func (e *GeocodingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GeocodingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GeocodingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GeocodingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
