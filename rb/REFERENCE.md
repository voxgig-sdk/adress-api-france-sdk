# AdressApiFrance Ruby SDK Reference

Complete API reference for the AdressApiFrance Ruby SDK.
...
#### `AdressApiFranceSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Geocoding.list(nil)
```
