...
class GeocodingEntity
  ...
  def make
    opts = @_entopts.dup
    GeocodingEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [GeocodingListMatch, Hash, nil] match filter (any subset of
  #   Geocoding fields); defaults to nil, treated as an empty match that lists all.
