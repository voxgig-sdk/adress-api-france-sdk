...
#      offline in seeded test mode (AdressApiFranceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AdressApiFrance_sdk.rb")
  SDK_CLASS = "AdressApiFranceSDK"
