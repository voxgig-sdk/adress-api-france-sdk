...
class BatchGeocodingEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ADRESSAPIFRANCE_TEST_BATCH_GEOCODING_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def batch_geocoding_basic_setup(extra)
  ...
  entid_env_raw = ENV["ADRESSAPIFRANCE_TEST_BATCH_GEOCODING_ENTID"]
