...
// AdressApiFrance SDK utility type

class AdressApiFranceUtility
{
    ...
    public static function copy(AdressApiFranceUtility $src): AdressApiFranceUtility
    {
        $u = new AdressApiFranceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
