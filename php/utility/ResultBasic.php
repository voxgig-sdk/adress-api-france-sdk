...
// AdressApiFrance SDK utility: result_basic

class AdressApiFranceResultBasic
{
    public static function call(AdressApiFranceContext $ctx): ?AdressApiFranceResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AdressApiFranceError) ? $result->err->msg : (string)$result->err;
