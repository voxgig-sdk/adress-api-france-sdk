...
// AdressApiFrance SDK utility: fetcher

class AdressApiFranceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AdressApiFranceSDK/1.0)';
    ...
    public static function call(AdressApiFranceContext $ctx, string $fullurl, array $fetchdef): array
    {
