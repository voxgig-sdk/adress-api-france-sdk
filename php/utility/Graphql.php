...
// AdressApiFrance SDK utility: graphql
//
...
class AdressApiFranceGraphql
{
    ...
    // equivalent.
    public static function body(AdressApiFranceContext $ctx): mixed
    {
    ...
    public static function errors(AdressApiFranceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
