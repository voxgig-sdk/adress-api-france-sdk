...
// AdressApiFrance SDK rbac feature
...
class AdressApiFranceRbacFeature extends AdressApiFranceBaseFeature
{
    ...
    private function _required(AdressApiFranceContext $ctx): ?string
    {
    ...
    private function _reject(AdressApiFranceContext $ctx, string $required): void
    {
    ...
    private function _track(AdressApiFranceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
