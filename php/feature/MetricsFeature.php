...
// AdressApiFrance SDK metrics feature
...
class AdressApiFranceMetricsFeature extends AdressApiFranceBaseFeature
{
    ...
    private function _record(AdressApiFranceContext $ctx, bool $ok): void
    {
