...
// AdressApiFrance SDK netsim feature
...
class AdressApiFranceNetsimFeature extends AdressApiFranceBaseFeature
{
    ...
    private function _simulate(AdressApiFranceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AdressApiFranceContext $ctx, array $applied): void
    {
        $client = $this->client;
