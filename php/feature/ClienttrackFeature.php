...
// AdressApiFrance SDK clienttrack feature
...
class AdressApiFranceClienttrackFeature extends AdressApiFranceBaseFeature
{
    ...
    public function PostConstruct(AdressApiFranceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AdressApiFrance-SDK';
