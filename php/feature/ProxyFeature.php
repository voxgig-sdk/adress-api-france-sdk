...
// AdressApiFrance SDK proxy feature
...
class AdressApiFranceProxyFeature extends AdressApiFranceBaseFeature
{
    ...
    public function init(AdressApiFranceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AdressApiFranceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
