...
// AdressApiFrance SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AdressApiFranceSDK::test)
...
{
    private const SDK_CLASS = 'AdressApiFranceSDK';
    ...
    private const SDK_BASE = 'adressapifrance_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../adressapifrance_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
