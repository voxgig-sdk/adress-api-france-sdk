...
// AdressApiFrance SDK Geocoding entity
...
class GeocodingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GeocodingEntity($this->_client, $opts);
    }

    /**
     * @param Geocoding|array $args Geocoding data (assoc-array) to store.
     */
    ...
    /**
     * @return Geocoding|array The current Geocoding data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Geocoding fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Geocoding fields).
     */
     ...
     *
     * @param GeocodingListMatch|array|null $reqmatch Match filter (any subset
     *   of Geocoding fields) as an assoc-array; GeocodingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Geocoding[]|array A list of Geocoding items as assoc-arrays at
     *   the SDK boundary; throws AdressApiFranceError on failure (item-5 convention).
     */
