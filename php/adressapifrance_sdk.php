...
class AdressApiFranceSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AdressApiFranceHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AdressApiFranceHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!AdressApiFranceFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, AdressApiFranceFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AdressApiFranceUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AdressApiFranceHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AdressApiFranceHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AdressApiFranceHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new AdressApiFranceError($op . "_allow",
                "AdressApiFranceSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AdressApiFranceHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new AdressApiFranceError("graphql_error",
                "AdressApiFranceSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function BatchGeocoding($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_batch_geocoding === null) {
                $this->_batch_geocoding = new BatchGeocodingEntity($this, null);
            }
            return $this->_batch_geocoding;
        }
        return new BatchGeocodingEntity($this, $data);
    }
    ...
    public function Geocoding($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_geocoding === null) {
                $this->_geocoding = new GeocodingEntity($this, null);
            }
            return $this->_geocoding;
        }
        return new GeocodingEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new AdressApiFranceSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
