// Command AdressApiFrance-mcp is an MCP server exposing the AdressApiFrance
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AdressApiFrance_list  — list records of an entity
//	AdressApiFrance_load  — load a single record of an entity
//
